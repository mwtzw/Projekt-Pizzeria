...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
      ...
      <div class="collapse-sm navbar-collapse collapse" id="navbarCollapse">
        ...
        <div class="d-flex justify-content-center">
            <ul class="text-white navbar-nav mb-2 mb-md-0">
                ...
                <li class="nav-item m-1 d-flex justify-content-center align-items-center">
                    <button class="btn cart pb-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"> <img src="./img/shopping-cart2.png" style="width:30px;" alt="koszyk"> </button>
                </li>
 ...
 <!-- order form  -->
    ...
    <div class="h-100 align-items-center d-flex justify-content-center flex-column">
        ...
        <button type="button" id="guzik" class="btn fw-bold"><a id="hrefguzik" class=" d-flex align-items-center justify-content-center text-white text-decoration-none" href="#text2">Sprawdź</a></button>
    </div>
    </div>
