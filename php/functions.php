            ...
            return <<< TEMPLATE
                <div class=" card m-4 rounded-5"> 
                    ...
                    <div class="pizza-description rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
                        ...
                        <button onclick="window.location.href='php/basket.php?action=add&id=$data[0]'" class="btn1 w-50 h-25 fs-4 rounded-5 border-0 fw-normal mt-2" type="button">  Do koszyka </button>
                    </div>
                </div>
            TEMPLATE;
        }
            ...
            return <<< TEMPLATE
                <div class="d-flex flex-row align-items-center align-items-center">  
                    <div id="cart-product" class=" d-flex rounded-4 mt-3 mb-3"> 
                        <div class="cart-product-photo h-100 d-flex justify-content-end align-items-center">
                ...
                <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <h1 class="fs-2 text-center fw-bold w-25">$price zł </h1>
                        </div>
                    </div>
                </div>
    ...
    class BasketClass {
        ...
        function getBasketCards() {
            ...
            foreach ($data as $key) {
                $id = $key['id'];
                $count = $key['count'];
                $query = "SELECT id, name, shortDescription, price FROM products WHERE id=$id";
                $result = Database->getData($query)->results;
                $cards .= Template->basketProductCard($result[0], $count);
            }
            return $cards;
        }
        ...
        function removeProduct($id, $count = 1) {
