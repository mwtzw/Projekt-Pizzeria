            ...
            <div class="row">
              <div class="offset-md py-5">
                <ul class="list-unstyled ">
                  ...
                  <li><button type="button" id="button-style" class="btn fs-3 text-align-center fw-bolder">Zaloguj się</button></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <strong class="fs-5">Pepperoni</strong>
                ...
                <header class="d-flex justify-content-center align-items-center py-3">
                  <ul class="nav nav-pills" id="men">
                    ...
                    <li class="nav-item">
                        <button type="button" id="button-style" class="btn w-100 fw-bold">Zaloguj się</button>
                    </li>
                                  <!-- koszyk -->
