...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
 ...
 <!-- order form  -->
      ...
      <div class="d-flex justify-content-center align-items-center mb-5">
        <div class="p=4 made w-75 mb-4">
          ...
          <div class="d-flex justify-content-center mb-5 ">
            ...
            <button id="button-access" class=" border-end border-top border-bottom fs-5 fw-bold rounded-5 rounded-start-0 text-white ps-3 pe-3"> Do koszyka </button>
          </div>
        </div>
      </div>
    </div>
  ...
  <?php if (User->isNotLoggedIn()) Content->generateLoginForm(); ?>
</body>
</html>