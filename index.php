...
<body>
            ...
            <div class="row">
              <div class="offset-md py-5">
                <ul class="list-unstyled ">
                  ...
                  <li> <button type="button"  data-bs-toggle="modal" data-bs-target="#login-page" class="button-style btn fs-3 text-align-center fw-bolder">Zaloguj się</button></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <strong class="fs-5">Pepperoni</strong>
                ...
                <header class="d-flex justify-content-center align-items-center py-3">
                  <ul class="nav nav-pills" id="men">
                    ...
                    <li class="nav-item">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#login-page" class="button-style btn w-100 fw-bold">Zaloguj się</button>
                    </li>
                                  <!-- koszyk -->
  ...
  <div id="payment1" class="d-flex justify-content-center align-items-center flex-wrap">
    ...
    <div class="infoblock d-flex align-items-center justify-content-center"> 
      <div class="infoblock-text w-50">  
        <p class="fs-1 ms-5"> Darmowe Wi-Fi w lokalu </p>
      </div>
      <div class="infoblock-image w-50 d-flex flex-column align-items-center justify-content-center"> 
