...
<body>
            ...
            <div class="row">
              <div class="offset-md py-5">
                <ul class="list-unstyled ">
                  ...
                  <li><a href="#" class="text-white p-3 m-1 rounded-2 fs-6">Historia</a></li>
                  <li> <button type="button" id="button-style" data-bs-toggle="modal" data-bs-target="#login-page" class="btn fs-3 text-align-center fw-bolder">Zaloguj się</button></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <strong class="fs-5">Pepperoni</strong>
                ...
                <header class="d-flex justify-content-center align-items-center py-3">
                  <ul class="nav nav-pills" id="men">
                    ...
                    <li class="nav-item"><a href="#" class=" text-white nav-link  me-3">Historia</a></li>
                    <li class="nav-item">
                        <button type="button" id="button-style" data-bs-toggle="modal" data-bs-target="#login-page" class="btn w-100 fw-bold">Zaloguj się</button>
                    </li>
                                  <!-- koszyk -->
                    <button class="btn cart" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"> <img src="/img/shopping-cart2.png" style="width:30px;" alt="koszyk"> </button>
                      <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                        ...
                        <div class="offcanvas-body">
                          <div class="d-flex justify-content-center align-items-start flex-column">
                            ...
                            <div class="d-flex flex-row align-items-center align-items-center">  
                              <div id="cart-product" class=" d-flex rounded-4 mt-3 mb-3"> 
                                <div class="cart-product-photo h-100 d-flex justify-content-end align-items-center"> <img src="/img/peperoni.png" class="pizza" alt="pizza"> </div>
                              ...
                              <h1 class="text-center fst-italic fs-3 w-25 ms-3"> 22zł </h1>
                              <img class="ms-4 bin" src="/img/bin.png" style="width:30px;"alt="bin">
                              </div>
                            </div>
                                <!-- cart product  -->
                                <!-- cart product  -->
                            <div class="d-flex flex-row align-items-center align-items-center">  
                              <div id="cart-product" class=" d-flex rounded-4 mt-3 mb-3"> 
                                <div class="cart-product-photo h-100 d-flex justify-content-end align-items-center"> <img src="/img/hawai.png" class="pizza" alt="pizza"> </div>
                              ...
                              <div class="d-flex flex-column">
                              <h1 class="text-center fst-italic fs-3 w-25 ms-3"> 25zł </h1>
                              <img class="ms-4 bin" src="/img/bin.png" style="width:30px;"alt="bin">
                              </div>
                            </div>
                                <!-- cart product  -->
                          ...
                          <div class="d-flex justify-content-center align-items-center">
                          <button type="button" class="finish w-75 text-white">Zamów</button>
                          <h1 class="fs-2 text-center fw-bold w-25"> 57zł </h1>
                          </div>
    ...
    <div class="h-100 align-items-center d-flex justify-content-center flex-column">
        ...
        <button type="button" id="guzik" class="btn fw-bold"><a id="hrefguzik" class=" d-flex align-items-center justify-content-center text-white text-decoration-none" href="#incrementor">Czytaj Więcej</a></button>
    </div>
    </div>
    ...
    <div class="container-fluid">
      ...
      <div class="p=4 made w-75 mb-4">
        <div id="comp" class="mt-5 mb-3 d-flex flex-wrap justify-content-center align-items-center">
            <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
                <img src="./img/cebula.jpg" style="width:100px;height: 200px;">
            ...
            <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
              <img src="./img/sosostry.jpg" style="width:100px;height: 200px;">
              <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
          ...
          <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
            <img src="./img/olwika.jpg" style="width:100px;height: 200px;">
        ...
        <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
          <img src="./img/zolty-ser-307663-4_3.jpg" style="width:100px;height: 200px;">
          <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
      ...
      <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
        <img src="./img/bekon.jpg" style="width:100px;height: 200px;">
        <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
  ...
  <div id="back2">
      ...
      <!-- login page -->
  <div class="modal fade" id="login-page" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- form  do zrobieniaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
    <form class="">
