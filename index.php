...
<body>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container">
        <header class="text-white d-flex justify-content-center align-items-center py-3">
          <nav class="navbar navbar-expand-md p-0 text-center h-100">
            ...
            <div class="collapse navbar-collapse " id="collapsibleNavbar">
              ...
              <ul class="navbar-nav mx-auto flex-fill ">
                ...
                <?php if(!User->isLoggedIn()) Content->generateLoginButton() ?>
                <?php if(User->isLoggedIn()) Content->generateBasketButton() ?>
              </ul>
            </div>
          </nav>
          <!-- =====================MEUN======================= -->
          ...
          <!-- user menu  -->
          <?php if(User->isLoggedIn()) Content->generateBasket(); ?>        
        </header>
      </div>
    </div>
  ...
  <?php if(!User->isLoggedIn()) Content->generateLoginForm(); ?>
</body>
