...
<script src="https://unpkg.com/aos@next/dist/aos.js"></script>
  <script>
    ...
    <header>
        <div class="collapse bg-dark" id="navbarHeader">
          <div class="container">
            <div class="row">
              <div class="offset-md py-5">
                <ul class="list-unstyled ">
                  <li><a href="#" class="text-white p-3 m-1 rounded-2 fs-6">Menu</a></li>
                  <li><a href="#" class="text-white p-3 m-1 rounded-2 fs-6">Najlepsza Pizza</a></li>
                  <li><a href="#" class="text-white p-3 m-1 rounded-2 fs-6">Zamów</a></li>
                  <li> <button type="button"  data-bs-toggle="modal" data-bs-target="#login-page" class="button-style2 btn fs-3 text-align-center fw-bolder">Zaloguj się</button></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div class="navbar navbar-dark bg-dark shadow-sm">
          <div class="container ">
            <a href="#" class="navbar-brand d-flex align-items-center">
              ...
              <strong class="fs-5">Pepperoni</strong>
            </a>
                <header class="d-flex justify-content-center align-items-center py-3">
                  <ul class="nav nav-pills" id="men">
                    <li class="nav-item"><a href="#" class=" text-white nav-link ">Menu</a></li>
                    <li class="nav-item"><a href="#" class=" text-white nav-link ">Pizze</a></li>
                    <li class="nav-item"><a href="#" class=" text-white nav-link ">Zamów</a></li>
    
                    <li class="nav-item">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#login-page" id="button-style" class="button-style2 btn w-100 fw-bold">Zaloguj się</button>
                    </li>
                    </ul>
                    <button class="btn cart ms-2 pb-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"> <img src="/img/shopping-cart2.png" style="width:30px;" alt="koszyk"> </button>
                    <!-- user menu  -->
                    <div class="dropdown-center ">
                      <button class="profile btn" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="./img/szef1.png" alt="icon">
                      </button>
                          ...
                          <div class="d-flex justify-content-center align-items-start flex-column">
                            ...
                            <div class="d-flex flex-row align-items-center align-items-center">  
                              <div id="cart-product" class=" d-flex align-items-center rounded-4 mt-3 mb-3"> 
                                <div class="cart-product-photo h-100 d-flex justify-content-start ms-1 align-items-center"> <img src="/img/peperoni.png" class="pizza" alt="pizza"> </div>
                                <div class="cart-product-description h-100 d-flex align-items-center justify-content-center flex-column"> <h1 class=" text-center fs-4 pt-4"> Peperoni <p class="fs-5 fw-lighter">Pizza z peperoni</p> </h1> </div>
                              
                              <div class="d-flex flex-column">
                              <h1 class="text-center fw-light fst-italic fs-4 w-25 ms-3 me-3" style="font-size:4px;"> 22,99zł </h1>
                              <img class="bin" src="/img/bin.png" style="width:30px;"alt="bin">
                              </div>
                              </div>
                            </div>
                                <!-- cart product  -->
                            ...
                            <div class="d-flex flex-row align-items-center align-items-center">  
                              <div id="cart-product" class=" d-flex align-items-center rounded-4 mt-3 mb-3"> 
                                <div class="cart-product-photo h-100 d-flex justify-content-start ms-1 align-items-center"> <img src="/img/hawai.png" class="pizza" alt="pizza"> </div>
                                <div class="cart-product-description h-100 d-flex align-items-center justify-content-center flex-column"> <h1 class=" text-center fs-4 pt-4"> Hawajska <p class="fs-5 fw-lighter">Pizza z ananasem</p> </h1> </div>
                              
                                <div class="d-flex flex-column">
                              <h1 class="text-center fw-light fst-italic fs-4 w-25 ms-3 me-3"> 25,99zł </h1>
                              <img class="bin" src="/img/bin.png" style="width:30px;"alt="bin">
                              </div>
                              </div>
                            </div>
 ...
 <!-- order form  -->
                          ...
                          <h1 class="fs-2 text-center fw-bold ms-4"> 57,99zł </h1>
                          </div>
      ...
      <div class="p=4 made w-75 mb-4">
        <div data-aos="zoom-in-up" data-aos-delay="0" id="comp" class="mt-5 mb-3 d-flex flex-wrap justify-content-center align-items-center">
            <div  class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
                <img src="./img/cebula.jpg" >
                <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
                    <h1 class="mt-3 fs-3 text-white">Cebula
                    </h1>
                    <div id="incrementor">
                        <input class="fs-5" type="number" value="0" name="nr" id="nr" min="0" max="5">  
                    </div>
                    <h1 class="mt-2 fs-6 text-white fst-italic fw-lighter">Cena: 2zł/szt</h1>
                </div>
                
            </div>
            <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
              <img src="./img/sosostry.jpg">
              <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
                  <h1 class="mt-3 fs-3 text-white">Sos Ostry</h1>
                  <div id="incrementor">
                      <input class="fs-5" type="number" value="0" name="nr" id="nr" min="0" max="1">  
                  </div>
                  <h1 class="mt-2 fs-6 text-white fst-italic fw-lighter">Cena: 5zł/szt</h1>
              </div>
              
          </div>
          <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
            <img src="./img/olwika.jpg" >
            <div class=" rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
                <h1 class="mt-3 fs-3 text-white">Oliwki</h1>
                <div id="incrementor">
                    <input class="fs-5" type="number" value="0" name="nr" id="nr" min="0" max="10">  
                </div>
                <h1 class="mt-2 fs-6 text-white fst-italic fw-lighter">Cena: 1zł/szt</h1>
            </div>
            
        </div>
        <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
          <img src="./img/zolty-ser-307663-4_3.jpg">
          <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
              <h1 class="mt-3 fs-3 text-white">Ser Zółty</h1>
              <div id="incrementor">
                  <input class="fs-5" type="number" value="0" name="nr" id="nr" min="0" max="2">  
              </div>
              <h1 class="mt-2 fs-6 text-white fst-italic fw-lighter">Cena: 4zł/szt</h1>
          </div>
          
      </div>

      <div class="product border rounded-5 d-flex flex-column align-items-center justify-content-start">
        <img src="./img/bekon.jpg">
        <div class="bg-success-emphasis rounded-5 rounded-top-0 w-100 h-100 text-center" style="background-color: #4f8f5b;">
            <h1 class="mt-3 fs-3 text-white">Bekon</h1>
            <div id="incrementor">
                <input class="fs-5" type="number" value="0" name="nr" id="nr" min="0" max="7">  
            </div>
            <h1 class="mt-2 fs-6 text-white fst-italic fw-lighter">Cena: 3zł/szt</h1>
        </div>
        ...
        <div class="d-flex justify-content-center mb-5 ">
          ...
          <h1 class="text-white fs-2 ps-3 pe-3 text-center fst-italic">Cena to: <b id="price" >20zł</b></h1>
          </div>
          <button id="button-access" class=" border-end border-top border-bottom fs-5 fw-bold rounded-5 rounded-start-0 text-white ps-3 pe-3"> Dodaj Pizze </button> 
        </div>
    </div>
    ...
    <div class="grid-parent d-flex flex-wrap justify-content-center">
      ...
      <div class=" card m-4 rounded-5"> 
        <div class="pizza-photo w-100 d-flex justify-content-center">
          <img src="img/hawai.png" class=" w-75 h-100 p-1">
        </div>
        <div class="pizza-description rounded-5 rounded-top-0 w-100 h-100 text-center">
          <H1 class="mt-2 text-white fw-bold fst-italic mt-3"> Hawajska</H1>
          <H2 class="mt-2 text-white fw-lighter fs-6 ps-4 pe-4"> Pizza z ananasem to bardzo smaczny wybór na ciepłe wieczory</H2>
          <div class="buttons d-flex justify-content-center align-items-center">
              <input label="30cm" type="radio" name="rozm" value="30cm">
              <input label="45cm" type="radio" name="rozm" value="45cm" checked>
              <input label="60cm" type="radio" name="rozm" value="60cm">
          </div>
          <h1 class="pizza-price text-white fw-bold"> 34 zł</h1>
          <button class="btn1 w-50 h-25 fs-5 rounded-5 border-0 fw-normal mt-2" type="button">  Do koszyka </button>
        </div>
      </div>
      </div>
      <!--pizza -->
      ...
      <div class=" card m-4 rounded-5"> 
        <div class="pizza-photo w-100 d-flex justify-content-center">
          <img src="img/peperoni.png" class=" w-75 h-100 p-1">
        </div>
        <div class="pizza-description rounded-5 rounded-top-0 w-100 h-100 text-center" >
          <H1 class="mt-2 text-white fw-bold fst-italic mt-3"> Pepperoni</H1>
          <H2 class="mt-2 text-white fw-lighter fs-6 ps-4 pe-4"> Pizza z peperoni to bardzo smaczny wybór na ciepłe wieczory</H2>
          <div class="buttons d-flex justify-content-center align-items-center">
              <input label="30cm" type="radio" name="rozm" value="30cm">
              <input label="45cm" type="radio" name="rozm" value="45cm">
              <input label="60cm" type="radio" name="rozm" value="60cm">
          </div>
          <h1 class="pizza-price text-white fw-bold"> 37 zł</h1>
          <button class="btn1 w-50 h-25 fs-5 rounded-5 border-0 fw-normal mt-2" type="button">  Do koszyka </button>
        </div>
      </div>
      </div>
      ...
      <div data-aos="zoom-in-up" data-aos-delay="300">
        <div class="card m-4 rounded-5"> 
          <div class="pizza-photo w-100 d-flex justify-content-center">
            <img src="img/meat.png" class=" w-75 h-100 p-1">
          </div>
          <div class="pizza-description rounded-5 rounded-top-0 w-100 h-100 text-center" >
            <H1 class="mt-2 text-white fw-bold fst-italic mt-3"> Mięsna</H1>
            <H2 class="mt-2 text-white fw-lighter fs-6 ps-4 pe-4"> Pizza z ananasem to bardzo smaczny wybór na ciepłe wieczory</H2>
            <div class="buttons d-flex justify-content-center align-items-center">
              <input label="30cm" type="radio" name="rozm" value="30cm">
              <input label="45cm" type="radio" name="rozm" value="45cm">
  ...
  <div class="d-flex justify-content-center align-items-center flex-wrap">
    ...
    <div class="stopkablock text-white d-flex flex-column "> 
      ...
      <ul class="fs-5 fst-italic">
        <a href="regulamin.html" style="color:white;"><li> Regulamin</li></a>
        <li> Promocje</li>
        <li> Kontakt</li>
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- form  do LOGOWANIA -->
    <form id="form1" class="m-3 d-block">
          <div class="form-floating mb-3">
            <input type="email" class="form-control rounded-4" id="floatingInput" placeholder=".">
            <label for="floatingInput">Adres e-mail</label>
          </div>
          <div class="form-floating mb-3">
            <input type="password" id="password-field" class="form-control rounded-3" id="floatingPassword" placeholder=".">
    ...
    <!-- form  -->
     ...
     <form id="form2" class="m-3 d-none">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <button class="w-50 mb-3 mt-2 btn btn-lg rounded-3 guzik-login" type="submit">Zarejestruj się</button>
          </div>
          <p class="fw-lighter text-center"> Masz już konto <b class="fw-bold" id="log"> Zaloguj się </b> </p>
