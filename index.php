...
<script src="https://unpkg.com/aos@next/dist/aos.js"></script>
  <script>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
      <div class="container">
            <header class="text-white d-flex justify-content-center align-items-center py-3">
              <nav class="navbar navbar-expand-md p-0 text-center h-100">
                <button class="navbar-toggler w-100 m-2 mx-auto" type="button" data-bs-toggle="collapse" data-bs-target="#collapsibleNavbar">
                ...
                <div class="collapse navbar-collapse " id="collapsibleNavbar">
                  ...
                  <strong class="fs-5 text-white">Pepperoni</strong>
                </a>
                    <ul class="navbar-nav mx-auto flex-fill ">
                        <li class="nav-item mx-auto mt-sm-3 mt-md-0 flex-fill">
                            <a class="nav-link $strefaKlienta" href="strefa_klienta.php">Menu</a>
                        </li>
                        <li class="nav-item mx-auto flex-fill">
                            <a class="nav-link $oFirmie" href="ofirmie.php">Najlepsze Pizze</a>
                        </li>
                        <li class="nav-item mx-auto flex-fill">
                            <a class="nav-link $aktualnosci" href="aktualnosci.php">Zamów</a>
                        </li>
                        <li>
                            <button type="button" data-bs-toggle="modal" data-bs-target="#login-page" class="button-style2 btn fs-3 text-align-center fw-bolder">Zaloguj się</button>
                        </li>
